...
def wishMe():
    ...
    speak("I am your  Vertual  Assistant Alex. Please tell me how may I help you")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif "hello" in query or "hello Alex" in query:
            hello1 = "Hello ! How May i Help you.."
            print(hello1)
            speak(hello1)

        elif "who are you" in query or "about you" in query or "your details" in query:
            who_are_you = "I am Alex an A I based computer program but i can help you lot like a your assistant ! try me to give simple command !"
            print(who_are_you)
            speak(who_are_you)
            ...
            naa_mme = "Thanks for Asking my self ! Alex"
            print(naa_mme)
            speak(naa_mme)
